...
description: |-
  The Proxmox VE (PVE) provider manages a Proxmox Virtual Environment cluster: nodes, networking, storage, guests (QEMU and LXC), high availability, firewall, backup, notifications, and SDN through the PVE REST API.
---
