...
var (
	_ datasource.DataSource              = &pveDownloadFileDataSource{}
	_ datasource.DataSourceWithConfigure = &pveDownloadFileDataSource{}
)

// NewPveDownloadFileDataSource returns the data source implementation.
func NewPveDownloadFileDataSource() datasource.DataSource {
	return &pveDownloadFileDataSource{}
}

// pveDownloadFileDataSource reads a single URL-downloaded file from a PVE
// storage via the /nodes/{node}/storage/{storage}/content listing.
type pveDownloadFileDataSource struct {
	client *pveclient.Client
}

// pveDownloadFileDataSourceModel is the Terraform-facing shape.
type pveDownloadFileDataSourceModel struct {
...
func (d *pveDownloadFileDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + TypeNamePveDownloadFile
}

// Schema implements datasource.DataSource.
func (d *pveDownloadFileDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Reads a single URL-downloaded file from a PVE storage content listing, including its size, format and creation time.",
...
func (d *pveDownloadFileDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *pveDownloadFileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data pveDownloadFileDataSourceModel
	...
	if err != nil {
		resp.Diagnostics.AddError(
			"Error reading pve_download_file data source",
